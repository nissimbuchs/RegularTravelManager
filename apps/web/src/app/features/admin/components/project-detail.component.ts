      ...
      <mat-card class="subprojects-card">
        ...
        <mat-card-content>
          <div class="table-container">
                ...
                <td mat-cell *matCellDef="let subproject">
                  <div class="address" *ngIf="hasAddress(subproject); else noAddress">
                    ...
                    <div class="address-text">
                      ...
                      <div class="city-postal">{{ subproject.locationCity }} {{ subproject.locationPostalCode }}</div>
                    </div>
                  </div>
              ...
              <ng-container matColumnDef="costPerKm">
                ...
                <td mat-cell *matCellDef="let subproject">
                  <div class="cost-info">
                    ...
                    <span class="cost-source" *ngIf="!subproject.costPerKm">
                      (inherited)
                    </span>
                  </div>
                </td>
              ...
              <ng-container matColumnDef="actions">
                ...
                <td mat-cell *matCellDef="let subproject">
                  <div class="action-buttons">
                    <button mat-icon-button (click)="editSubproject(subproject)"
                            matTooltip="Edit Location">
                      <mat-icon>edit_location</mat-icon>
                    </button>
                    
                    <button mat-icon-button (click)="toggleSubprojectStatus(subproject)"
                    ...
                    <button mat-icon-button (click)="deleteSubproject(subproject)"
            ...
            <mat-paginator *ngIf="subprojects.length > 0"
...
export class ProjectDetailComponent implements OnInit, OnDestroy {
  ...
  private loadSubprojects(projectId: string): void {
    this.projectService.getSubprojects(projectId).pipe(
      takeUntil(this.destroy$)
    ).subscribe({
      next: (subprojects) => {
  ...
  toggleSubprojectStatus(subproject: Subproject): void {
    ...
    dialogRef.afterClosed().subscribe(confirmed => {
      if (confirmed) {
        this.projectService.toggleSubprojectStatus(this.project!.id, subproject.id).pipe(
          takeUntil(this.destroy$)
        ).subscribe({
          next: () => {
            this.loadSubprojects(this.project!.id);
  ...
  deleteSubproject(subproject: Subproject): void {
    ...
    dialogRef.afterClosed().subscribe(confirmed => {
      if (confirmed) {
        this.projectService.deleteSubproject(this.project!.id, subproject.id).pipe(
          takeUntil(this.destroy$)
        ).subscribe({
          next: () => {
            this.loadSubprojects(this.project!.id);
  ...
  hasAddress(subproject: Subproject): boolean {
    return !!(subproject.locationStreet || subproject.locationCity || subproject.locationPostalCode);
  }
