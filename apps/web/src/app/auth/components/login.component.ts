        ...
        <mat-card-content>
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="login-form">
            ...
            <button mat-raised-button
              ...
              <mat-spinner *ngIf="isLoading$ | async" diameter="20" class="login-spinner"></mat-spinner>
    ...
    if (this.loginForm.valid) {
      ...
      this.authService.login(credentials).subscribe({
        ...
        error: (error) => {
          ...
          this.snackBar.open(error.message || 'Login failed. Please check your credentials and try again.', 'Close', {
            duration: 5000,
