...
- [x] Create sample seed data (AC: 5)
  - [x] Insert 2 sample employees with Swiss home addresses
  - [x] Insert 1 sample manager with proper employee relationship
  - [x] Insert 2 sample projects with Swiss business context
  - [x] Insert subprojects with realistic Swiss locations and coordinates
  - [x] Create sample travel requests to test complete workflow

- [x] Set up database migration system (AC: 6)
...
- [x] Configure connection pooling (AC: 7)
...
- **Seed Data**: Realistic Swiss business data with accurate coordinates for Zürich, Bern, Basel, Geneva, Lausanne, and St. Gallen
...
- `apps/api/src/database/seeds/001_initial_seed_data.sql` - Swiss business context seed data
