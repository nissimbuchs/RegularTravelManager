...
- [ ] **New API Endpoints** - REST endpoints for deployment:
  ...
  - [ ] `DELETE /projects/{id}` - Delete project with safety checks
...
- [ ] **API Gateway** - Routes to be configured:
  ...
  - Routes: /projects/*, /subprojects/*, /admin/projects/* (not deployed)
- [ ] **Lambda Configuration** - Functions to be deployed:
  - File: `infrastructure/lib/lambda-stack.ts`
  - Functions: createProjectFunction, getAllProjectsFunction, projectManagementFunction
