...
- [x] **State Management** - NgRx actions/effects for form state management implemented
...
### Backend Changes
- [x] **New API Endpoints** - REST endpoints implemented:
  - [x] `POST /travel-requests` - Submit new travel request
  - [x] `GET /projects/active` - Get active projects for dropdown
...
- [x] **Lambda Functions** - Lambda handlers implemented:
  - [x] Handler file: `apps/api/src/handlers/travel-requests/submit-request.ts`
  - [x] Handler file: `apps/api/src/handlers/projects/get-active-projects.ts`
  - [x] Handler file: `apps/api/src/handlers/calculations/calculate-preview.ts`
...
- [x] **API Gateway** - Routes configured:
  ...
  - Routes: /travel-requests, /projects/*, /calculations/*
- [x] **Lambda Configuration** - Functions deployed:
  - File: `infrastructure/src/lambda-stack.ts`
  - Functions: submitRequestFunction, getProjectsFunction, calculatePreviewFunction
