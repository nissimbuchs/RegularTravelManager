...
- [ ] **New API Endpoints** - REST endpoints for deployment:
  ...
  - [ ] `GET /projects/active` - Get active projects for dropdown
  - [ ] `GET /projects/{id}/subprojects` - Get subprojects for selection
...
- [ ] **API Gateway** - Routes to be configured:
  ...
  - Routes: /travel-requests, /projects/*, /calculations/* (commented but not deployed)
